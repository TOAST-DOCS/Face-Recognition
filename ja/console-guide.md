...
## AI Service > Face Recognition > コンソール使用ガイド { #ai-service-face-recognition-console-user-guide }
...
## 顔の検出および分析 { #recognize-and-analyze-faces }

<a id="photo-upload-for-face-recognition-and-analysis"></a>
### 顔の検出および分析を行うための事前アップロード { #photo-upload-for-face-recognition-and-analysis }
...
### 顔を比較するための画像アップロード { #photo-upload-for-comparing-faces }
...
### Threshold設定 { #threshold-settings }
